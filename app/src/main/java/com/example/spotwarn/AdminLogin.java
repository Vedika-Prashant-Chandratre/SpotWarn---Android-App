        ...
        tvForgotPassword.setOnClickListener(v -> {
            ...
            auth.sendPasswordResetEmail(email)
                    ...
                    .addOnFailureListener(e ->
                            Toast.makeText(AdminLogin.this, "Error: " + e.getMessage(), Toast.LENGTH_LONG).show()
                    );
        });
    }
    ...
    private void loginUser() {
        ...
        auth.signInWithEmailAndPassword(email, password)
                .addOnSuccessListener(authResult -> {
                    ...
                    startActivity(new Intent(AdminLogin.this, PoliceDashboardActivity.class));
                    finish();
                })
                .addOnFailureListener(e ->
                        Toast.makeText(AdminLogin.this, "Login Failed: " + e.getMessage(), Toast.LENGTH_LONG).show()
                );
    }
